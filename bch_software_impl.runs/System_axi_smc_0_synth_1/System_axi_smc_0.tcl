...
read_ip -quiet h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0.xci
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.runs/System_axi_smc_0_synth_1 -new_name System_axi_smc_0 -ip [get_ips System_axi_smc_0]]
...
if { [catch {
  file copy -force H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.runs/System_axi_smc_0_synth_1/System_axi_smc_0.dcp h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.runs/System_axi_smc_0_synth_1/System_axi_smc_0_stub.v h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.runs/System_axi_smc_0_synth_1/System_axi_smc_0_stub.vhdl h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.runs/System_axi_smc_0_synth_1/System_axi_smc_0_sim_netlist.v h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.runs/System_axi_smc_0_synth_1/System_axi_smc_0_sim_netlist.vhdl h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.ip_user_files/ip/System_axi_smc_0]} {
  catch { 
    file copy -force h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_stub.v H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.ip_user_files/ip/System_axi_smc_0
  }
}

if {[file isdir H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.ip_user_files/ip/System_axi_smc_0]} {
  catch { 
    file copy -force h:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.srcs/sources_1/bd/System/ip/System_axi_smc_0/System_axi_smc_0_stub.vhdl H:/dev/CSASA/vivaldo_starter/helloworld_working/helloworld_working.ip_user_files/ip/System_axi_smc_0
  }
}
